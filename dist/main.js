...
class App {
    ...
    resizeCanvas() {
        ...
        var parentWidth = (_a = this.canvas.parentElement) === null || _a === void 0 ? void 0 : _a.offsetWidth;
        var parentHeight = (_b = this.canvas.parentElement) === null || _b === void 0 ? void 0 : _b.offsetHeight;
...
class Renderer {
    ...
    async setupDevice() {
        ...
        for (let i = 0; i < numCanvas; i++) {
            //get the canvas element with id gfx-main
            const canvas = document.getElementById("gfx-test" + i);
            // Canvas configuration
            const contextTest = canvas.getContext("webgpu");
            this.canvasFormat = navigator.gpu.getPreferredCanvasFormat();
    ...
    async makePipeline() {
        ...
        this.cellShaderModule = this.device.createShaderModule({
            label: "Cell shader",
            code: _shaders_vertexshaders_wgsl__WEBPACK_IMPORTED_MODULE_2__["default"]
        });
        ...
        const cellShaderModuleTest = this.device.createShaderModule({
            label: "Cell shader",
            code: _shaders_vertexshaders_test_wgsl__WEBPACK_IMPORTED_MODULE_3__["default"]
        });
        // Create a pipeline that renders the cell.
    ...
    copyBufferUsingCompute(buffer1, buffer2) {
        ...
        var copierBindGroup = this.device.createBindGroup({
        ...
        // Create the compute shader that will process the game of life simulation.
        var copierShaderModule = this.device.createShaderModule({
            label: "Simulation shader1",
            code: _shaders_compute_copier_shader_wgsl__WEBPACK_IMPORTED_MODULE_1__["default"]
        });
        ...
        // Create a compute pipeline that updates the game state.
        var copierPipeline = this.device.createComputePipeline({
            label: "Simulation pipeline",
...
/***/ "./src/view/shaders/compute/copier_shader.wgsl":
/*!*****************************************************!*\
  !*** ./src/view/shaders/compute/copier_shader.wgsl ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/view/shaders/vertexshaders_test.wgsl":
/*!**************************************************!*\
  !*** ./src/view/shaders/vertexshaders_test.wgsl ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
